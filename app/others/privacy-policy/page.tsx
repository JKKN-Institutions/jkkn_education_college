    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: '#f5f0e8' }}>
        <div className="mx-auto max-w-7xl">
          {/* Opening Paragraph */}
          <p className="text-base md:text-lg leading-relaxed mb-8" style={{ color: '#4a5568' }}>
          ...
          <h2 className="text-2xl md:text-3xl font-bold mb-4" style={{ color: '#2d3748' }}>
            Information We Collect
          </h2>

          <p className="text-base md:text-lg leading-relaxed mb-6" style={{ color: '#4a5568' }}>
          ...
          <p className="text-base md:text-lg leading-relaxed mb-4" style={{ color: '#4a5568' }}>
