      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: '#f5f0e8' }}>
        <div className="mx-auto max-w-4xl">
          ...
          <div className="flex justify-center mb-8">
            <div className="relative w-full max-w-[350px] h-[280px] md:h-[320px]">
              <Image
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl md:text-4xl font-bold mb-2" style={{ color: '#1e7f4e' }}>
              Dr.KM.Ranjendiran
            </h1>
            <h2 className="text-2xl md:text-3xl font-bold mb-2" style={{ color: '#1e7f4e' }}>
              Principal
            </h2>
            <h3 className="text-xl md:text-2xl font-bold mb-6" style={{ color: '#1e7f4e' }}>
              JKKN College of Education
            </h3>
          </div>

          {/* Principal's Message Heading */}
          <h2 className="text-2xl md:text-3xl font-bold text-center mb-8" style={{ color: '#1e7f4e' }}>
            Principal's Message
          </h2>
          ...
          <div className="space-y-6 text-justify">
            {/* Welcome */}
            <p className="text-base md:text-lg font-semibold" style={{ color: '#4a5568' }}>
            ...
            {/* Signature */}
            <div className="pt-6">
              <p className="text-base md:text-lg font-semibold mb-6" style={{ color: '#4a5568' }}>
                Sincerely,
              </p>
              <p className="text-base md:text-lg font-bold" style={{ color: '#4a5568' }}>
                Dr.KM.Ranjendiran
              </p>
              <p className="text-base md:text-lg font-semibold" style={{ color: '#4a5568' }}>
