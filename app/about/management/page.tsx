        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 mb-16">
            ...
            <div className="flex flex-col items-center">
              ...
              {/* Name and Title */}
              <h2 className="text-xl md:text-2xl font-bold text-center mb-4" style={{ color: '#000' }}>
                SMT.N.SENDAMARAAI
              </h2>
              <h3 className="text-lg md:text-xl font-bold text-center mb-6" style={{ color: '#1e7f4e' }}>
                CHAIRPERSON - JKKN EDUCATIONAL INSTITUTIONS
              </h3>

              {/* Description */}
              <p className="text-sm md:text-base leading-relaxed text-justify" style={{ color: '#5a6c7d' }}>
              ...
              <p className="text-sm md:text-base leading-relaxed text-justify mt-4" style={{ color: '#5a6c7d' }}>
