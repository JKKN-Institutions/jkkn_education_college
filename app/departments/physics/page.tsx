  ...
  return (
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div>
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                ...
                <span style={{ color: '#ff6633' }}>Physics</span>
              </h1>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6 sm:mb-8 lg:mb-12">
                ...
                {/* Placement */}
                <div className="p-6 rounded-lg text-center" style={{ backgroundColor: 'rgba(0, 0, 0, 0.2)' }}>
                  <div className="text-4xl font-bold mb-2" style={{ color: '#ff6633' }}>95%</div>
            ...
            {/* Right Content - Progressive Education Card */}
            <div className="relative">
              <div className="p-4 sm:p-6 lg:p-8 xl:p-12 rounded-lg sm:rounded-xl lg:rounded-2xl"
                   style={{ backgroundColor: 'rgba(0, 90, 127, 0.6)', backdropFilter: 'blur(10px)' }}>
                <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-8 text-center" style={{ color: '#ffffff' }}>
                  Physics Education
                </h3>
                <div className="h-1 w-20 mx-auto mb-8" style={{ backgroundColor: '#ff6633' }}></div>
                <p className="text-lg leading-relaxed text-center" style={{ color: 'rgba(255, 255, 255, 0.95)' }}>
                  <span className="font-semibold">Progressive Education</span> — Shaping future Physics educators since 1954
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="p-8 rounded-xl" style={{ backgroundColor: '#ffffff', boxShadow: '0 2px 8px rgba(0,0,0,0.1)' }}>
              <div className="flex items-center gap-3 mb-8">
                ...
                <h3 className="text-2xl font-bold" style={{ color: '#ff6633' }}>
                  Required Documents
                </h3>
              </div>
      ...
      <section className="py-10 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: '#ffffff' }}>
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-8 sm:mb-12 lg:mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold mb-4" style={{ color: '#003d5c', fontStyle: 'italic' }}>
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-12">
            <button
              ...
              style={{
                ...
                color: activeSemester === 'semester1' ? '#003d5c' : '#5a6c7d',
            ...
            <button
              ...
              style={{
                ...
                color: activeSemester === 'semester2' ? '#003d5c' : '#5a6c7d',
            ...
            <button
              ...
              style={{
                ...
                color: activeSemester === 'semester3' ? '#003d5c' : '#5a6c7d',
            ...
            <button
              ...
              style={{
                ...
                color: activeSemester === 'semester4' ? '#003d5c' : '#5a6c7d',
          ...
          {activeSemester === 'semester1' && (
            <div className="space-y-6">
              {/* Course 1 */}
              <div className="flex gap-6 p-6 rounded-xl" style={{ backgroundColor: '#f8f9fa', boxShadow: '0 2px 8px rgba(0,0,0,0.05)' }}>
                ...
                <div className="flex-1">
                  ...
                  <p className="mb-3 leading-relaxed" style={{ color: '#4a5568' }}>
                  ...
                  <div className="flex gap-6 text-sm" style={{ color: '#5a6c7d' }}>
                    <span>Credits: 4</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="p-8 rounded-xl border-l-4" style={{ backgroundColor: '#f8f9fa', borderColor: '#ff6633', boxShadow: '0 2px 8px rgba(0,0,0,0.1)' }}>
              <div className="flex items-start gap-4 mb-4">
                ...
                <h3 className="text-xl font-bold pt-2" style={{ color: '#003d5c' }}>
                  70+ Years of Educational Excellence
                </h3>
              </div>
              <p className="leading-relaxed ml-16" style={{ color: '#5a6c7d' }}>
            ...
            <div className="relative">
              ...
              <div className="flex flex-col lg:flex-row items-center mb-0">
                <div className="w-full lg:w-5/12 lg:pr-8 mb-4 lg:mb-0 order-2 lg:order-1">
                  <div className="p-6 rounded-xl" style={{ backgroundColor: '#f8f9fa', boxShadow: '0 2px 8px rgba(0,0,0,0.08)' }}>
                ...
                <div className="flex flex-col items-center order-1 lg:order-2 lg:w-2/12">
                  ...
                  <div className="w-0.5 h-24 lg:h-32" style={{ backgroundColor: '#ff6633' }}></div>
                </div>
              ...
              <div className="flex flex-col lg:flex-row items-center mb-0">
                ...
                <div className="flex flex-col items-center order-1 lg:order-2 lg:w-2/12">
                  ...
                  <div className="w-0.5 h-24 lg:h-32" style={{ backgroundColor: '#0ea5e9' }}></div>
                </div>
                <div className="w-full lg:w-5/12 lg:pl-8 mb-4 lg:mb-0 order-2 lg:order-3">
                  <div className="p-6 rounded-xl" style={{ backgroundColor: '#f8f9fa', boxShadow: '0 2px 8px rgba(0,0,0,0.08)' }}>
                    <h3 className="text-xl font-bold mb-3" style={{ color: '#003d5c' }}>
              ...
              <div className="flex flex-col lg:flex-row items-center">
                ...
                <div className="flex flex-col items-center order-1 lg:order-2 lg:w-2/12">
                  ...
                  <div className="w-0.5 h-16" style={{ backgroundColor: '#0ea5e9' }}></div>
                </div>
                <div className="w-full lg:w-5/12 lg:pl-8 mb-4 lg:mb-0 order-2 lg:order-3">
                  <div className="p-6 rounded-xl" style={{ backgroundColor: '#f8f9fa', boxShadow: '0 2px 8px rgba(0,0,0,0.08)' }}>
                    <h3 className="text-xl font-bold mb-3" style={{ color: '#003d5c' }}>
          ...
          <div className="max-w-4xl mx-auto space-y-4">
            ...
            <details className="group p-6 rounded-xl" style={{ backgroundColor: '#ffffff', boxShadow: '0 2px 8px rgba(0,0,0,0.05)' }}>
              <summary className="flex justify-between items-center cursor-pointer list-none">
                <h3 className="text-lg font-bold" style={{ color: '#003d5c' }}>
                  What is the eligibility for B.Ed Physics admission?
                </h3>
                <svg className="w-5 h-5 transition-transform group-open:rotate-180" style={{ color: '#003d5c' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
