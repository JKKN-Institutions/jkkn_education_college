    ...
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div>
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                ...
                <span style={{ color: '#ff6633' }}>Microbiology</span>
              </h1>
            ...
            <div className="relative">
              <div className="p-12 rounded-2xl text-center"
                ...
                <p className="text-lg leading-relaxed" style={{ color: 'rgba(255, 255, 255, 0.9)' }}>
                  <span className="font-semibold">Progressive Education</span> — Shaping future Microbiology educators since 1954
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-10 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: '#ffffff' }}>
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-8 sm:mb-12 lg:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4" style={{ color: '#003d5c' }}>
              Program <span style={{ color: '#0ea5e9' }}>Highlights</span>
            </h2>
            <div className="h-1 w-20 mx-auto mb-8" style={{ backgroundColor: '#ff6633' }}></div>
      ...
      <section className="py-10 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: '#ffffff' }}>
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-8 sm:mb-12 lg:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4" style={{ color: '#003d5c' }}>
              Curriculum <span style={{ color: '#0ea5e9' }}>Structure</span>
            </h2>
            <div className="h-1 w-20 mx-auto mb-8" style={{ backgroundColor: '#ff6633' }}></div>
            <p className="text-sm sm:text-base lg:text-lg" style={{ color: '#5a6c7d' }}>
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-12">
            {[1, 2, 3, 4].map((sem) => (
              <button
                ...
                style={{
                  backgroundColor: activeSemester === sem ? '#003d5c' : '#f8f9fa',
          ...
          <div className="space-y-4">
            {curriculumData[activeSemester as keyof typeof curriculumData].map((course, index) => (
              <div
                ...
                style={{ backgroundColor: '#f8f9fa', boxShadow: '0 2px 8px rgba(0,0,0,0.05)' }}
              >
                <div
                  className="flex-shrink-0 w-16 h-16 rounded-lg flex flex-col items-center justify-center text-white font-bold"
                  style={{ backgroundColor: course.code === 'MIC' ? '#0ea5e9' : '#003d5c' }}
                >
                ...
                <div className="flex-1">
                  ...
                  <p className="leading-relaxed mb-3" style={{ color: '#5a6c7d' }}>
                    {course.description}
                  </p>
                  <div className="flex gap-4 text-sm" style={{ color: '#5a6c7d' }}>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-8 sm:mb-12 lg:mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold mb-4" style={{ color: '#ffffff' }}>
              Career <span style={{ color: '#ff6633' }}>Prospects</span>
            </h2>
            <div className="h-1 w-20 mx-auto mb-8" style={{ backgroundColor: '#ff6633' }}></div>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="rounded-xl overflow-hidden transition-transform hover:scale-105">
              <div className="h-32 flex items-center justify-center" style={{ backgroundColor: '#003d5c' }}>
                <h3 className="text-xl font-bold text-white text-center px-4">Microbiology Lab</h3>
              </div>
              <div className="p-4" style={{ backgroundColor: '#003d5c' }}>
            ...
            {/* Digital Library */}
            <div className="rounded-xl overflow-hidden transition-transform hover:scale-105">
              <div className="h-32 flex items-center justify-center" style={{ backgroundColor: '#0ea5e9' }}>
                <h3 className="text-xl font-bold text-white text-center px-4">Digital Library</h3>
              </div>
              <div className="p-4" style={{ backgroundColor: '#0ea5e9' }}>
            ...
            {/* Smart Classrooms */}
            <div className="rounded-xl overflow-hidden transition-transform hover:scale-105">
              <div className="h-32 flex items-center justify-center" style={{ backgroundColor: '#ff6633' }}>
                <h3 className="text-xl font-bold text-white text-center px-4">Smart Classrooms</h3>
              </div>
              <div className="p-4" style={{ backgroundColor: '#ff6633' }}>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-center mb-0">
              <div className="w-1/2 pr-8 text-right">
                <div className="p-6 rounded-xl inline-block text-left" style={{ backgroundColor: '#ffffff', boxShadow: '0 2px 8px rgba(0,0,0,0.1)' }}>
                  <h3 className="text-xl font-bold mb-3" style={{ color: '#003d5c' }}>Check Eligibility</h3>
                  <p className="leading-relaxed" style={{ color: '#5a6c7d' }}>
              ...
              <div className="flex flex-col items-center">
                <div className="w-10 h-10 rounded-full flex items-center justify-center text-white font-bold"
                     style={{ backgroundColor: '#ff6633' }}>1</div>
                <div className="w-0.5 h-32" style={{ backgroundColor: '#ff6633' }}></div>
              </div>
            ...
            <div className="flex items-center mb-0">
              ...
              <div className="flex flex-col items-center">
                <div className="w-10 h-10 rounded-full flex items-center justify-center text-white font-bold"
                     style={{ backgroundColor: '#ff6633' }}>2</div>
                <div className="w-0.5 h-32" style={{ backgroundColor: '#ff6633' }}></div>
              </div>
            ...
            <div className="flex items-center mb-0">
              ...
              <div className="flex flex-col items-center">
                <div className="w-10 h-10 rounded-full flex items-center justify-center text-white font-bold"
                     style={{ backgroundColor: '#ff6633' }}>3</div>
                <div className="w-0.5 h-32" style={{ backgroundColor: '#ff6633' }}></div>
              </div>
              <div className="w-1/2 pl-8"></div>
            </div>
            ...
            <div className="flex items-center mb-0">
              ...
              <div className="flex flex-col items-center">
                <div className="w-10 h-10 rounded-full flex items-center justify-center text-white font-bold"
                     style={{ backgroundColor: '#ff6633' }}>4</div>
                <div className="w-0.5 h-32" style={{ backgroundColor: '#0ea5e9' }}></div>
              </div>
              <div className="w-1/2 pl-8">
                <div className="p-6 rounded-xl" style={{ backgroundColor: '#ffffff', boxShadow: '0 2px 8px rgba(0,0,0,0.1)' }}>
                  <h3 className="text-xl font-bold mb-3" style={{ color: '#003d5c' }}>Counseling & Seat Allotment</h3>
                  <p className="leading-relaxed" style={{ color: '#5a6c7d' }}>
            ...
            <div className="flex items-center mb-0">
              <div className="w-1/2 pr-8 text-right">
                <div className="p-6 rounded-xl inline-block text-left" style={{ backgroundColor: '#ffffff', boxShadow: '0 2px 8px rgba(0,0,0,0.1)' }}>
                  <h3 className="text-xl font-bold mb-3" style={{ color: '#003d5c' }}>Fee Payment & Enrollment</h3>
                  <p className="leading-relaxed" style={{ color: '#5a6c7d' }}>
              ...
              <div className="flex flex-col items-center">
                <div className="w-10 h-10 rounded-full flex items-center justify-center text-white font-bold"
                     style={{ backgroundColor: '#ff6633' }}>5</div>
                <div className="w-0.5 h-32" style={{ backgroundColor: '#0ea5e9' }}></div>
              </div>
              <div className="w-1/2 pl-8"></div>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div className="flex flex-col items-center">
                <div className="w-10 h-10 rounded-full flex items-center justify-center text-white font-bold"
                     style={{ backgroundColor: '#ff6633' }}>6</div>
              </div>
              <div className="w-1/2 pl-8">
                <div className="p-6 rounded-xl" style={{ backgroundColor: '#ffffff', boxShadow: '0 2px 8px rgba(0,0,0,0.1)' }}>
                  <h3 className="text-xl font-bold mb-3" style={{ color: '#003d5c' }}>Orientation & Classes Begin</h3>
                  <p className="leading-relaxed" style={{ color: '#5a6c7d' }}>
