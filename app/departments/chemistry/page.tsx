          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div>
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                ...
                <span style={{ color: '#ff6633' }}>Chemistry</span>
              </h1>
            ...
            <div className="relative">
              <div className="p-8 rounded-2xl"
                ...
                <p className="text-lg leading-relaxed text-center" style={{ color: 'rgba(255, 255, 255, 0.95)' }}>
                  <span className="font-semibold">Progressive Education</span> — Nurturing future Chemistry educators since 1954
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-12">
            <button
              ...
              style={{
                backgroundColor: activeSemester === 'semester1' ? '#003d5c' : '#ffffff',
                color: activeSemester === 'semester1' ? '#ffffff' : '#003d5c',
            ...
            <button
              ...
              className="px-8 py-3 rounded-lg font-semibold transition-all"
              style={{
                backgroundColor: activeSemester === 'semester2' ? '#003d5c' : '#ffffff',
                color: activeSemester === 'semester2' ? '#ffffff' : '#003d5c',
                boxShadow: '0 2px 8px rgba(0,0,0,0.1)'
              }}
            >
              Semester II
            ...
            <button
              ...
              className="px-8 py-3 rounded-lg font-semibold transition-all"
              style={{
                backgroundColor: activeSemester === 'semester3' ? '#003d5c' : '#ffffff',
                color: activeSemester === 'semester3' ? '#ffffff' : '#003d5c',
                boxShadow: '0 2px 8px rgba(0,0,0,0.1)'
              }}
            >
              Semester III
            ...
            <button
              ...
              className="px-8 py-3 rounded-lg font-semibold transition-all"
              style={{
                backgroundColor: activeSemester === 'semester4' ? '#003d5c' : '#ffffff',
                color: activeSemester === 'semester4' ? '#ffffff' : '#003d5c',
                boxShadow: '0 2px 8px rgba(0,0,0,0.1)'
              }}
            >
              Semester IV
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="relative max-w-5xl mx-auto">
            ...
            <div className="absolute left-1/2 transform -translate-x-1/2 h-full w-1 hidden lg:block"
                 style={{ background: 'linear-gradient(to bottom, #ff6633 0%, #0ea5e9 100%)' }}></div>
      ...
      <section className="py-10 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: '#ffffff' }}>
        <div className="mx-auto max-w-7xl">
          ...
          <div className="max-w-5xl mx-auto space-y-4">
            {/* FAQ 1 */}
            <details className="group p-6 rounded-xl" style={{ backgroundColor: '#f8f9fa', boxShadow: '0 2px 8px rgba(0,0,0,0.05)' }}>
      ...
      <section className="py-10 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: '#ff6633' }}>
        <div className="mx-auto max-w-5xl text-center">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            ...
            <button className="inline-flex items-center gap-2 px-10 py-4 rounded-lg font-semibold border-2 border-white text-white transition-all hover:bg-white hover:text-orange-500">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
