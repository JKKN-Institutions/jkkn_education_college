          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div>
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                ...
                <span style={{ color: '#ff6633' }}>Political Science</span>
              </h1>
            ...
            <div className="relative">
              <div className="p-12 rounded-2xl text-center"
                ...
                <p className="text-lg leading-relaxed" style={{ color: 'rgba(255, 255, 255, 0.9)' }}>
                  <span className="font-semibold">Progressive Education</span> — Shaping future Political Science educators since 1954
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-2 mb-12">
            {curriculum.map((sem, index) => (
              <button
                ...
                style={{
                  backgroundColor: activeTab === index ? '#003d5c' : 'transparent',
                  ...
                  <div
                    ...
                    style={{
                      background: course.code.startsWith('POL')
                        ? 'linear-gradient(135deg, #005a7f 0%, #003d5c 100%)'
